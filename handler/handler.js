...
function postProc(filename) {
    ...
    if (userConfig.description == " " && userConfig.author == " ") {
        ...
        content = `<html> <head> ${metaTags} <script src="https://cdn.tailwindcss.com"></script> </head> <style> body { height: 75vh; background: #1f2329; color: #ffffff; } @media screen and (min-height: 700px) { .div { margin-top: 12.5%;} } @media screen and (max-height: 701px) { .div { margin: 10px; } } img { width: 50%; } </style> <body> <div class="div"> <img class="mx-auto p-4 md:p-0" src="${newfile}"> <h1 class="text-xl md:text-2xl font-bold text-center p-1"> Uploader: ${user} </h1> </div> </body> </html>`;
    } else if (userConfig.description == " ") {
        const metaTags = `<meta name="twitter:card" content="summary_large_image"> <meta name="twitter:image" content="https://${domain}/users/${user}/${end[1]}/${newfile}"> <meta name="twitter:image:src" content="https://${domain}/users/${user}/${end[1]}/${newfile}"> <meta property="og:image" content="https://${domain}/users/${user}/${end[1]}/${newfile}"> <meta property="og:title" content="${userConfig.title}"> <meta name="twitter:title" content="${userConfig.title}">`;

        content = `<html> <head> ${metaTags} <link type="application/json+oembed" href="https://${domain}/users/${user}/author.json"> <script src="https://cdn.tailwindcss.com"></script> </head> <style> body { height: 75vh; background: #1f2329; color: #ffffff; } @media screen and (min-height: 700px) { .div { margin-top: 12.5%;} } @media screen and (max-height: 701px) { .div { margin: 10px; } } img { width: 50%; } </style> <body> <div class="div"> <img class="mx-auto p-4 md:p-0" src="${newfile}"> <h1 class="text-xl md:text-2xl font-bold text-center p-1"> Uploader: ${user} </h1> </div> </body> </html>`;
        ...
        content = `<html> <head> <meta name="twitter:card" content="summary_large_image"> <meta name="twitter:image" content="https://${domain}/users/${user}/${end[1]}/${newfile}"> <meta name="twitter:image:src" content="https://${domain}/users/${user}/${end[1]}/${newfile}"> <meta property="og:image" content="https://${domain}/users/${user}/${end[1]}/${newfile}"> <meta property="og:title" content="${userConfig.title}"> <meta name="twitter:title" content="${userConfig.title}"> <meta name="twitter:description" content="${userConfig.description}"> <meta property="og:description" content="${userConfig.description}"> <link type="application/json+oembed" href="https://${domain}/users/${user}/author.json"> <script src="https://cdn.tailwindcss.com"></script> </head> <style> body { height: 75vh; background: #1f2329; color: #ffffff; } @media screen and (min-height: 700px) { .div { margin-top: 12.5%;} } @media screen and (max-height: 701px) { .div { margin: 10px; } } img { width: 50%; } </style> <body> <div class="div"> <img class="mx-auto p-4 md:p-0" src="${newfile}"> <h1 class="text-xl md:text-2xl font-bold text-center p-1"> Uploader: ${user} </h1> </div> </body> </html>`;
    }
